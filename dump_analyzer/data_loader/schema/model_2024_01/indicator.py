...
class BipIndicator(BaseModel):
    INDICATOR_CHOICES: ClassVar = Literal[
...
class UsageCounts(BaseModel):
    views: Optional[str] = Field(
        None, description="The number of views for this result."
    )
    downloads: Optional[str] = Field(
        None, description="The number of downloads for this result."
    )
