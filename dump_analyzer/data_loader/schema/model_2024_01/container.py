...
class Container(BaseModel):
    ...
    conferenceplace: Optional[str] = Field(
        None, description="The place of the conference."
    )
    conferencedate: Optional[str] = Field(
        None, description="The date of the conference."
    )
