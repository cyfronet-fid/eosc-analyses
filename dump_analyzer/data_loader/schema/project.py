...
class Funder(BaseModel):
    ...
    name: Optional[str] = Field(None, description="The name of the funder (European Commission)")
    shortName: Optional[str] = Field(None, description="The short name of the funder (EC)")


class Validated(BaseModel):
    validatedByFunder: Optional[bool] = Field(None, description="Is validated by funder")
...
class Project(BaseModel):
    ...
    funder: Optional[Funder] = Field(None, description="Information about the funder funding the project")
    id: Optional[str] = Field(None, description="The OpenAIRE id for the project")
    provenance: Optional[Provenance] = Field(None, description="Why this result is associated with Project")
    title: Optional[str] = Field(None, description="The title of the project")
    validated: Optional[Validated] = Field(None, description="Is the Project validated by funder")
